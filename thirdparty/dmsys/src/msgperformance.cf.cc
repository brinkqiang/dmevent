...
void CDMCF_msgperformance::ReadXML_dmnode_xmsg(::msgperformance::dmnode_xmsg& node, const pugi::xml_node& oXml)
{
    ...
    node.set_msgid(lexical_cast<::google::protobuf::uint32>(oXml.child("msgid").text().as_string()));
    
    node.set_maxconsumetime(lexical_cast<::google::protobuf::uint64>(oXml.child("maxconsumetime").text().as_string()));
    
    node.set_avgconsumetime(lexical_cast<::google::protobuf::uint64>(oXml.child("avgconsumetime").text().as_string()));
    
    node.set_totalconsumetime(lexical_cast<::google::protobuf::uint64>(oXml.child("totalconsumetime").text().as_string()));
    
    node.set_msgcount(lexical_cast<::google::protobuf::uint64>(oXml.child("msgcount").text().as_string()));
    
    node.set_totalmsgsize(lexical_cast<::google::protobuf::uint64>(oXml.child("totalmsgsize").text().as_string()));
    
    node.set_lasttime(lexical_cast<::std::string>(oXml.child("lasttime").text().as_string()));
    
}
void CDMCF_msgperformance::ReadXML_dmnode_xtotal(::msgperformance::dmnode_xtotal& node, const pugi::xml_node& oXml)
{
    
    node.set_totalsize(lexical_cast<::google::protobuf::uint64>(oXml.child("totalsize").text().as_string()));
