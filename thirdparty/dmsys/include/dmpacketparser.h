...
class IDMPacketParser {
  public:
    ...
    virtual int32_t DMAPI GetMsgHeaderSize() = 0;
    virtual int32_t DMAPI BuildPacketHeader(void* pHeader, int32_t nDataLen) = 0;
...
class HDMPacketParser :
  ...
  public:
    ...
    virtual int32_t DMAPI GetMsgHeaderSize();
...
class HNotParser :
  ...
  public:
    ...
    virtual int32_t DMAPI BuildPacketHeader(void* pHeader, int32_t nDataLen) { return 0; }
...
public:
    ...
    virtual int32_t DMAPI GetMsgHeaderSize() { return 0; }
